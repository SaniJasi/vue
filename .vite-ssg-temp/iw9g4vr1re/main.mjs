...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  if ($setup.isOpen) {
    _push(
      `<div${ssrRenderAttrs(
        mergeProps({ class: 'popup' }, _attrs)
      )} data-v-2ed80e1e><div class="popup__content" data-v-2ed80e1e>`
    )
    ssrRenderSlot(_ctx.$slots, 'default', {}, null, _push, _parent)
    _push(
      `<div class="popup__actions" data-v-2ed80e1e><button class="btn btn--red" data-v-2ed80e1e>Yes</button><button class="btn btn--secondary" data-v-2ed80e1e>No</button></div></div></div>`
    )
  } else {
    _push(`<!---->`)
  }
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  ;(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'src/components/PopupConfirmation.vue'
  )
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0
}
const Popup = /* @__PURE__ */ _export_sfc(_sfc_main$4, [
  ['ssrRender', _sfc_ssrRender$1],
  ['__scopeId', 'data-v-2ed80e1e'],
  ['__file', '/Users/a51.hs/Desktop/vue-todo/src/components/PopupConfirmation.vue']
])
const useTodoListStore = defineStore('todoList', {
  ...
  getters: {
    getTodoByName: (state) => {
      return (name) =>
        state.todoList.find((todo) => todo.item.name.toLowerCase().replace(/ /g, '-') === name)
    }
  },
  persist: true
})
    ...
    ssrRenderList((_a = todo.item.todos) == null ? void 0 : _a.slice(0, 3), (field, index) => {
      _push(
        `<div><input type="checkbox"${
          ssrIncludeBooleanAttr(
            Array.isArray(field.checked) ? ssrLooseContain(field.checked, null) : field.checked
          )
            ? ' checked'
            : ''
        } disabled> ${ssrInterpolate(field.name)}</div>`
      )
    })
      ...
      },
      {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode('p', null, 'Are you sure you want to remove this item?')]
          }
        }),
        _: 1
        /* STABLE */
...
const TodoList = /* @__PURE__ */ _export_sfc(_sfc_main$3, [
  ['ssrRender', _sfc_ssrRender],
  ['__file', '/Users/a51.hs/Desktop/vue-todo/src/components/TodoList.vue']
])
const _sfc_main$2 = {
  __name: 'index',
...
const __pages_import_0__ = /* @__PURE__ */ _export_sfc(_sfc_main$2, [
  ['__file', '/Users/a51.hs/Desktop/vue-todo/src/pages/index.vue']
])
const __pages_import_1__ = () => import('./assets/create-6a7a54ad.js')
const __pages_import_2__ = () => import('./assets/_...all_-71cf4dc6.js')
const routes = [
  { name: 'index', path: '/', component: __pages_import_0__, props: true },
  { name: 'create', path: '/create', component: __pages_import_1__, props: true },
  { name: 'all', path: '/:all(.*)*', component: __pages_import_2__, props: true }
]
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<header${ssrRenderAttrs(mergeProps({ class: 'site-header' }, _attrs))} data-v-5f378fbb>`
      )
      _push(
        ssrRenderComponent(
          unref(RouterLink),
              ...
              if (_push2) {
                _push2(
                  `<img${ssrRenderAttr(
                    'src',
                    _imports_0
                  )} alt="" data-v-5f378fbb${_scopeId}><span data-v-5f378fbb${_scopeId}>Todo list</span>`
                )
              } else {
                return [
                  createVNode('img', {
          ...
          },
          {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                return [createTextVNode('Create item')]
              }
            }),
            _: 1
            /* STABLE */
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$1, [
  ['__scopeId', 'data-v-5f378fbb'],
  ['__file', '/Users/a51.hs/Desktop/vue-todo/src/components/HeaderSection.vue']
])
const _sfc_main = {
  __name: 'App',
  __ssrInlineRender: true,
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [
  ['__file', '/Users/a51.hs/Desktop/vue-todo/src/App.vue']
])
...
export { Popup as P, _export_sfc as _, createApp, useTodoListStore as u }
